# Objective 5.4 — Deep Translation Review

## Source boundaries
- Objective 5.4 starts at transcript line 9461.
- Objective 5.5 starts at transcript line 9689.
- Objective 5.4 spans lines 9461–9688.

## Topics
1. Improper charging
2. Poor battery health
3. Swollen battery
4. Physically damaged ports
5. Overheating
6. Liquid damage
7. Broken screen
8. Digitizer/touch issues
9. Stylus issues
10. Cursor drift/touch calibration
11. Wi-Fi/Bluetooth no connectivity
12. Poor/intermittent wireless connectivity
13. Malware/rogue applications
...
- Liquid suspected → power off first.
- Normal display but touch fails → digitizer/settings.
- Stylus fails → power → pairing/configuration → damage.
- Cursor drift → recalibrate digitizer.
- No wireless → adapter/configuration/antenna/peripheral battery.
- Intermittent wireless → range/pairing/interference.
- Strange behavior/data/privacy use → consider malware/rogue app.
- Sluggish mobile device → close background apps/free storage.
